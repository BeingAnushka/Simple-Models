# -*- coding: utf-8 -*-
"""SMSSpamFilterModel.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vy-pSOAkNLbDUUgmhom1tAyrkxE8zxo4
"""
...
predict_msg = ["I love you."]
predict_spam(predict_msg)

predict_msg = ["Max safety assured on your Wed Treat! Enjoy KFC combos with 4x safety starting at just Rs. 299. Order now! Order bit.ly/3gVZ5zO Optout bit.ly/2HH02eY T&C*"]
predict_spam(predict_msg)

predict_msg = ["While receiving an international call, if an Indian number or no number is displayed on your phone, please inform on DoT toll free number 1800 110 420 / 1963"]
predict_spam(predict_msg)